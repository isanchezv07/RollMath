...
export const level3: LevelConfig = {
    ...
    description: "Use fans to blow the ball around and multiply to reach the goal!",
    goal: 15,
    entities: [
        // Numbers 0-9
        ...
        // Level 3 Obstacles: Walls and Spinners
        { type: "wall", x: 350, y: 325, options: { width: 500, height: 10, angle: 0 }},
        { type: "spinner", x: 200, y: 500, options: { speed: 0.05, radius: 60 }},
        { type: "spinner", x: 500, y: 500, options: { speed: -0.05, radius: 60 }},
    ]
};
